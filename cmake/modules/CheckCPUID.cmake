...
macro( CheckCPUID )
  if(NOT DEFINED CPUID_CACHED)
    ...
    if(${CPUID_FLAG} GREATER 2)
      set(SUPPORT_ssse3 TRUE CACHE INTERNAL "Local CPU support for SSE3")
      message(STATUS "CPU supports SSSE3")
    else()
      message(STATUS "CPU does not support SSSE3")
    endif()
